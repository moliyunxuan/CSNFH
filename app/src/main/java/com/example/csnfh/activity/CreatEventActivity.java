...
public class CreatEventActivity extends AppCompatActivity  implements OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //获得当前社团
        farmItem = (FarmItem) getIntent().getSerializableExtra("CREATE_COMM_EVENT");
    ...
    private boolean validate() {
        ...
        if (name.isEmpty() || name.length() > 20) {
            ed_event_name.setError("请输入小于20位活动主题名");
            valid = false;
        } else {
