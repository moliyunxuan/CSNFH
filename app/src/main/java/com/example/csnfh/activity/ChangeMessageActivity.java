    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_verify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //请求短信
                BmobSMS.requestSMSCode(ed_new_message.getText().toString(), "", new QueryListener<Integer>() {
                    @Override
        ...
        switch (type) {
            case CHANGE_TYPE_STU_NAME:
                //更改用户名
                ed_old_message.setText(BmobUser.getCurrentUser(User.class).getUserName());
            ...
            case CHANGE_TYPE_MOBILE:
                //更改手机号
                ed_old_message.setText(BmobUser.getCurrentUser(User.class).getMobilePhoneNumber());
            ...
            case CHANGE_TYPE_EMAIL:
                //更改邮箱
                ed_old_message.setText(BmobUser.getCurrentUser(User.class).getEmail());
            ...
            public void onClick(View v) {
                ...
                switch (type) {
                    case CHANGE_TYPE_STU_NAME:
                       ...
                       newUser.setUserName(strNewMessage);
                    ...
                    case CHANGE_TYPE_MOBILE:
                        ...
                        newUser.setMobilePhoneNumber(strNewMessage);
                       newUser.setUsername(strNewMessage);
                    ...
                    case CHANGE_TYPE_EMAIL:
                        ...
                        newUser.setEmail(strNewMessage);
        ...
        newUser.update(BmobUser.getCurrentUser(User.class).getObjectId(), new UpdateListener() {
            ...
            public void done(BmobException e) {
                if (e == null) {
                    ...
                    Log.i("htht", "更新用户信息成功！！ " + BmobUser.getCurrentUser(User.class).getUserName());
                } else {
                    String errorMessage;
                    switch (e.getErrorCode()) {
                        case 202:
